/*
 Tests:
   ...
   compile: gcc -O2 -o bench main.c -lpthread -lm
*/

/* Feature-test macros MUST come before ANY system includes on glibc (Debian/Ubuntu).
   On Arch this order was more forgiving; Debian's glibc is strict about it. */
#ifndef _WIN32
...
/* ------tuning------ */
#ifdef _WIN32
    static int64_t INT_ITR = 5000000000LL;
#else
    static long  INT_ITR        = 5000000000L;
#endif
static long  FP_ITR         = 2000000000L;
static long  BRANCH_ITR     = 500000000L;
static long  STREAM_BYTES   = 512L * 1024 * 1024;
static int   CHASE_NODES    = 64 * 1024 * 1024;
static int   BOOST_STEPS    = 10;
static long  BOOST_ITR      = 500000000L;
...
static void boost_bench(void) {
    printf("\n8: boost / throttle detection  (%d samples x %ldM itr)\n",
